...
- Each contract → contract test task [P] [test-automator]
- Each entity → model creation task [P] [database-optimizer]
- Each user story → integration test task [test-automator]
- API endpoints → implementation tasks [backend-architect]
- Setup/Config → tasks [general-purpose]
- Documentation → tasks [docs-architect]
